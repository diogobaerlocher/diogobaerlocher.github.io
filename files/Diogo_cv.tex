...
\href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4249006}{Natural Disasters Support Dictatorships: Evidence from Brazil} \\
(with Renata Caldas, Francisco Cavalcanti and Rodrigo Schneider) \\
\rotatebox[origin=c]{180}{$\Lsh$}\textit{Presentations:} 
\begin{minipage}[t]{0.7\textwidth}
21\textsuperscript{st} Annual Society for the Advancement of Economic Theory Conference (2022)$\dagger$
\end{minipage}
...
\rotatebox[origin=c]{180}{$\Lsh$}\textit{Presentations:} 
\begin{minipage}[t]{0.7\textwidth}
2021 Liberal Arts Development Conference*; \\ 43\textsuperscript{rd} Meeting of the Brazilian Econometric Society (2021)*
\end{minipage}
...
\textbf{\textit{Economic Theory}}, 73, 211–236 ('22)  \\
\rotatebox[origin=c]{180}{$\Lsh$}\textit{Presentations:} 
\begin{minipage}[t]{0.7\textwidth}
        BCAM VI: Online Workshop on Public Employment ('20)$\dagger$ $\cdot$ SEA 90th Annual Meeting ('20) $\cdot$
        Kenyon College ('19)$\dagger$ $\cdot$ 
        University of Wisconsin at Whitewater ('19)$\dagger$ $\cdot$ 
        University of South Florida  ('19)$\dagger$ $\cdot$ 
        University of Windsor  ('19)$\dagger$
\end{minipage}
...
Fall 2020 (Online, 4.1,4.25/5) $\cdot$ Fall 2021 (4.19/5) $\cdot$ Spring 2022 (3.95/5)
\end{minipage}
...
$\cdot$ Research Committee (chair, 2022 - )
