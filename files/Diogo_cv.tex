...
$\cdot$ 43\textsuperscript{rd} SBE* 
$\cdot$ 5\textsuperscript{th} Florida-WATE$^\dagger$ 
$\cdot$ LACEA 2023$^\dagger$ 
$\cdot$ 2\textsuperscript{nd} LAUrban Meeting$^\dagger$
\end{minipage}
...
\href{https://diogobaerlocher.github.io/files/inflationcosts.pdf}{Financial Exclusion and Inflation Costs}
...
\rotatebox[origin=c]{180}{$\Lsh$}\textit{Presentations:} 
\begin{minipage}[t]{0.7\textwidth}
2024 AREUEA/ASSA Meeting$^\dagger$
\end{minipage}
...
\textbf{2020}: \begin{minipage}[t]{0.9\textwidth}
        BCAM VI: Online Workshop on Public Employment$^\dagger$ $\cdot$ SEA 90th Annual Meeting
        \end{minipage}\\        
...
\indent \hspace{1cm}  \begin{minipage}[t]{0.75\textwidth}
Revista Brasileira de Economia $\cdot$ The B.E. Journal of Macroeconomics (3) $\cdot$ Nova Economia $\cdot$ Public Choice (2) $\cdot$ World Development $\cdot$ Population Review $\cdot$ Social Policy and Administration $\cdot$ Applied Economics Letters $\cdot$ Journal of Labor Research
\end{minipage}
