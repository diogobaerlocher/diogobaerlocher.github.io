...
$\cdot$ {\color{gray} Urban Economic Association Conference}
$\cdot$ {\color{gray} 6\textsuperscript{th} Florida-WATE (2024)}
\end{minipage}
...
\textbf{2024}: \begin{minipage}[t]{0.9\textwidth}
        \emph{Mariana Talks}
        $\cdot$ {\color{gray} Urban Economic Association} $\cdot$ {\color{gray} 6\textsuperscript{th} Florida WATE}
        \end{minipage}\\
